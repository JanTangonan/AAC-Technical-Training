USE [VENTURA_DEV]
GO
/****** Object:  Trigger [dbo].[LABITEM_CREATE_SUBITEM]    Script Date: 1/27/2025 11:39:02 AM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    DECLARE @labItemNumberPrefix VARCHAR(50);
    DECLARE @newLabItemNumber VARCHAR(50);

    -- Get AUTO_CREATE_SUBITEM_FLAG from TV_ITEMTYPE
    SELECT 
        @autoCreateSubitemFlag = t.AUTO_CREATE_SUBITEM,
    ...
    BEGIN
        ...
        SET @newLabItemNumber = @labItemNumberPrefix + '.1';

        -- Insert the subitem into TV_LABITEM
