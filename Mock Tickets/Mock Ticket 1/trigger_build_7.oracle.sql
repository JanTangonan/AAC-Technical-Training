...
COMPOUND TRIGGER
    ...
    BEGIN
        ...
        IF :NEW."Parent ECN" IS NULL THEN
            -- Fetch the Auto Create Subitem flag from the ITEMTYPE table
            ...
            IF autoCreateSubitemFlag = 'T' THEN
                BEGIN
                    -- Fetch sequence values and prepare subitem and labstat details
    ...
    BEGIN
        FOR idx IN 1 .. subitems.COUNT LOOP
            ...
            -- Insert a labstat record into LABSTAT
            INSERT INTO LABSTAT (
                "Status Key",
                "Case Key",
                "Evidence Control Number",
