$(document).ready(() => {
    ...
    function rowHighlight() {
        ...
        /// <param>None.</param>
        /// <return type = "void">Void.</return>
        $('.cases-table-body').on('click', 'tr', function () {
    ...
    function saveUpdate() {
        ...
        if (selectedRow) {
            const updatedData = {
                ...
                DEPARTMENT_CASE_NUMBER: document.getElementById("departmentCaseNumber").value,
                DEPARTMENT_CODE: document.getElementById("ddlDepartment").value,
                OFFENSE_CODE: document.getElementById("ddlCharge").value,
                LAB_CASE: document.getElementById("labCaseNumber").value,
                OFFENSE_DATE: document.getElementById("incedentReportDate").value
            };
    ...
    function resetSelectedRow() {
        /// <summary>Resets Selected Row.</summary>
        /// <param>None.</param>
        /// <return type = "void">Void.</return>
        $('.form-table input').val('');
        $('.form-table select').prop('selectedIndex', 0);
        selectedRow = null;
    }
});