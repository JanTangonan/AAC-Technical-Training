...
namespace BEASTiLIMS
{
    ...
    public class Exercise_Arvinn_AjaxWS : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        public static DataTable GetReversedCsv(string csvInput)
        {
            DataTable resultTable = new DataTable();
            PLCQuery qry = new PLCQuery();
            qry.AddProcedureParameter("CsvInput", csvInput,50, OleDbType.VarChar, ParameterDirection.Input);
            qry.ExecuteProcedure("ReverseCsvOrder");
