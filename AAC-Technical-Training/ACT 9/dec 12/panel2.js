(function ($) {
    ...
    $.fn.dbPanel = function (options) {
        ...
        var settings = $.extend({}, $.fn.dbPanel.defaults, $controlPanel.data(), options);

        var readMethod = $controlPanel.data("read");
        var updateMethod = $controlPanel.data("update");
        ...
        if (updateMethod && typeof window[updateMethod] === "function") {
            settings.update = window[updateMethod];
        }
        ...
        console.log("PANEL DEFAULTS: ", $.fn.dbPanel.defaults);
    ...
    $.fn.dbPanel.defaults = {
        /// Control danel Default settings
