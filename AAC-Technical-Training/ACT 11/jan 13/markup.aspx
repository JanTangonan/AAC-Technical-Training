<%@ Page Title="" Language="C#" MasterPageFile="~/LIMSHOME.master" AutoEventWireup="true" CodeBehind="Exercise_Arvin_Report.aspx.cs" Inherits="BEASTiLIMS.Exercise_Arvin_Report" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
        <ContentTemplate>
            ...
            <PLC:PLCDBGrid ID="dbgLabItem" runat="server" AutoGenerateColumns="false" CssClass="grid" DataKeyNames="EVIDENCE_CONTROL_NUMBER" AutoPostBack="true"
                BorderStyle="None" BorderWidth="0px" BorderColor="Transparent" SelectedRowStyle-BackColor="#7FFFD4"
                OnSelectedIndexChanged="dbgLabItem_SelectedIndexChanged" PLCGridWidth="1000">
            </PLC:PLCDBGrid>

            <asp:Button  ID="btnPrintCaseDetails" runat="server" Text="Print Case Details" OnClick="btnPrintCaseDetails_Click" Width="130px"/>
            <asp:Button  ID="btnPrintItemDetails" runat="server" Enabled="false" Text="Print Item Details" OnClick="btnPrintItemDetails_Click" Width="130px"/>
