...
private int GetOldestJuvenileAge()
{
    int oldestJuvenile = PLCSession.SafeInt(PLCSession.GetLabCtrl("OLDEST_JUVENILE"), 0);

    return oldestJuvenile > 0 ? oldestJuvenile : 18;
}